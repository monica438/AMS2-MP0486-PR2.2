...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(Manager.collectionToString(
                Ciutat.class,
                Manager.listCollection(Ciutat.class, "")
        ));

        System.out.println("Ciutadans creats:");
        System.out.println(Manager.collectionToString(
                Ciutada.class,
                Manager.listCollection(Ciutada.class, "")
        ));
        ...
        for (Ciutat ciutat : ciutats) {
            System.out.println("Ciutat: " + Manager.getCiutatWithCiutadans(ciutat.getCiutatId()));
            
        }

        System.out.println("CIUTADANS:");
        List<Ciutada> llista_ciutadans = Manager.listCollection(Ciutada.class,"");
        
        for (Ciutada ciutada : llista_ciutadans) {
            System.out.println("Ciutadà: " + ciutada);
        }
        ...
        for (Ciutat ciutat : ciutats) {
            List<Ciutada> ciutadans =
                    Manager.getCiutadansByCiutat(ciutat.getCiutatId());
